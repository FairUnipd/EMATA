...
%Optional parameters
%
%IDIF_extraction_call(PET_dyn_path, t_PET_delta, out_path, 'MoCo', MOCO_flag)
% MOCO_flag = 1 or 0 (default = 1)
%
%IDIF_extraction_call(PET_dyn_path, t_PET_delta, out_path, 'Patlak', PATLAK_flag)
% PATLAK_flag = 1 or 0 (default = 1)
%
%IDIF_extraction_call(PET_dyn_path, t_PET_delta, out_path, 'extractionSite', site)
% site = 'ICA' (default) or 'CCA'
%
%IDIF_extraction_call(PET_dyn_path, t_PET_delta, out_path, 'InputFun', 'IDIF', 'extractionSite', site)
% site = 'ICA' (default) or 'CCA'
%
%IDIF_extraction_call(PET_dyn_path, t_PET_delta, out_path, 'InputFun', 'AIF', AIF_struct)
% AIF_struct =
%   AIF.c  [Bq/ml]
%   AIF.t  [sec]
%
%IDIF_extraction_call(PET_dyn_path, t_PET_delta, out_path, 'InputFun', 'AIF', AIF_struct, 'Feng', doFeng)
% AIF_struct =
%   AIF.c  [Bq/ml]
%   AIF.t  [sec]
% doFeng = 1 or 0 (default = 1)
%
%IDIF_extraction_call(PET_dyn_path, t_PET_delta, out_path, 'InputFun', 'IDIF', 'extractionSite', site, 'Feng', doFeng)
% site = 'ICA' (default) or 'CCA'
% doFeng = 1 or 0 (default = 1)
%
%IDIF_extraction_call(PET_dyn_path, t_PET_delta, out_path, 'Feng', doFeng)
% doFeng = 1 or 0 (default = 1)
%
...
%
%IDIF_extraction_call(PET_dyn_path, t_PET_delta, out_path, 'options', options_path)
%options_path <-- .json file path for tuning parameters

function IDIF_extraction_call(PET_dyn_path, t_PET_delta, out_path, varargin)
...
if MOCO_FLAG
    ...
    if ~exist(outfile_MOCO)
        ...
        outfile_MOCO = motion_correction(PET_dyn_path, MOCO_path, tgframe, iframe, fframe);
    end
...
generate_pseudo_static_PET(IN_PET_dyn,t_PET_emi, COREG_path);
